...
export default function SezioneMateriale({
  ...
  if (active) {
    return (
      <div className="p-8">
        <Link
          href="http://localhost:3000/esercizio?data=2025-12-01&inizio=10%3A40&fine=15%3A30"
        ...
        <br />
        <Link
          href="http://localhost:3000/esercizio?data=2025-12-01&inizio=15%3A30&fine=20%3A30"
          className="text-blue-500 hover:text-blue-400"
        >
        ...
        <br />
        <Link
          href="http://localhost:3000/esercizio?data=2025-12-01&inizio=06%3A40&fine=10%3A41"
          className="text-blue-500 hover:text-blue-400"
        >
        ...
        <br />
        <Link
          href="http://localhost:3000/esercizio?data=2025-12-01&inizio=15%3A29&fine=20%3A30"
          className="text-blue-500 hover:text-blue-400"
        >
